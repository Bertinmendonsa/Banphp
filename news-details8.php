...
<html>
	...
	<!-- ––––––––––––––––––––––––––––––––––––––––– -->
        ...
        <link href="assets/css/news1/css/style.css" rel="stylesheet" type="text/css">
        <link href="assets/css/news1/css/responsive.css" rel="stylesheet" type="text/css">
        <!-- font-awesome -->

        <link href="assets/css/news1/css/effects/normalize.css" rel="stylesheet" type="text/css">

        <link href="assets/css/news1/css/effects/component.css"  rel="stylesheet" type="text/css" >
<!-- Bootstrap -->
    ...
    <link href="assets/css/search1.css" rel="stylesheet">
     <link href="assets/css/animate.css" rel="stylesheet">
        ...
        <link rel="stylesheet" href="assets/css/new-details.css">
...
.dropdown1:hover .dropdown-content {
	...
	<div id="pageWrapper" class="page-wrapper">
        ...
        <!-- –––––––––––––––[ HEADER ]––––––––––––––– -->
        <main role="main-inner-wrapper" class="container newsmargin"  >
<div class="blog-details">
                	...
                	<article class="post-details" id="post-details">
                        ...
                        <header role="bog-header" class="bog-header text-center">
                            ...
                            <h3><span>24</span> July 2016</h3>
</header>
                     <figure>

                            <img src="assets/images/news1/4.jpg" alt="" class="img-responsive" style="width: 100%"/>
