                ...
                <div class="container">
                   <div class="row pb-60" id="view2">
                       <div class="col-lg-4 col-md-5 ptb-10">
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/shivram.jpg"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox">
                            <h3 class="t-uppercase">
                                <a class="profilename">Shri Shivaraman</a>
                            </h3>
<!--                            <h5 class="mb-15 color-theme">MBBS, MS, FIOO </h5>-->
                            <h5 class="mb-15">Manager-Marketing</h5>
