                ...
                <div class="container">
                   <div class="row pb-60" id="view2">
                        <div class="col-lg-4 col-md-5 ptb-10 photo" >
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/doctors/Alok.jpg"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox navalign ">
                            <h3 class="t-uppercase">
                                <a class="profilename">Dr. Alok B Swamy</a>
                            </h3>
                            <h5 class="mb-15">MBBS, MS, FCRS </h5>
                            <h5 class="mb-15">Phaco, Cornea & Refractive Surgeon</h5>
                            ...
                            <p class="color-mid mb-20">Dr. Alok B. S. completed his MBBS from JNMC, Belgaum (RGUHS) in 2009 and his post graduation (MS) in ophthalmology from JNMC Belgaum (KLE University) in 2013. <br/>He then went on to do his long term surgical fellowship in Cornea, Phaco and Refractive surgery from MM Joshi Eye Hospital, Hubballi.<br/>He has been working in Bangalore Nethralaya since its inception of Kalyan Nagar branch and has done numerous topical Phaco cataract surgeries and refractive surgeries to his credit. His special interest lies in treating corneal diseases and phaco-refractive procedures including LASIK, PRK, C3R, OPTICAL KERATOPLASTY, DSAEK, DALK, TRAB, PTERYGIUM SURGERY, AMT TRANSPLANTATION, SLET-SIMPLE LIMBAL EPITHELIAL TRANSFER, and KPRO keeping in line with the latest technologies available.<br/>He has presented various papers at multiple state & national conferences.</p>
<!--                            <a href="appointment.php" class="btn btn-blue">Make Appoinment</a>-->
                             <div class="spl">
                                 <a href="appointment.php" class="btn btn-blue">Make Appointment</a>
          <a class="btn btn-round btn-blue" href="sharadha.php"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
<a class="btn btn-round btn-blue" href="janhavi.php"><i class="fa fa-chevron-right" aria-hidden="true" ></i></a>
