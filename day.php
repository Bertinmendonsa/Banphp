                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1 col-xs-12 text-center">
                            <div class="section-top-title">
                                <h1 class="t-uppercase font-45">DAY CARE PROCEDURES
...
<!--            <h2 class="mb-10" style="color: black; margin-top: -1px;">ABOUT GUIDE TO EYE EXAMINATION</h2>-->
        
        <p class="paragraph" id="fsize">Anti-VEGF (Avastin, Lucentis, Macugen), triamcenalone, Ozurdex, or<br> any intra-vitreal Injections
Phacoemulsification with foldable IOL implantation under topical anesthesia<br>
LASIK Treatment<br>
I & C for Chalazion, Cryotherapy, Pneumoretinopexy, Pterygium excision<br> & grafting, and most of the eye surgeries</p>
    </div>
</div> 
        </section>
            <!-- End Hero Area -->
