	...
	<div id="pageWrapper" class="page-wrapper">
        ...
        <main id="mainContent" class="main-content" >
            ...
            <section class="doctors-area doctors-list ptb-80 bg-gray">
                <div class="container">
                    <div class="row pb-60" id="view1">
                        <div class="col-lg-4 col-md-5 ptb-10 photo">
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/doctors/Janhavi.jpg"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox navalign">
                            <h3 class="t-uppercase">
                                <a class="profilename">Dr. H Janhavi</a>
                            </h3>
                             <h5 class="mb-15">MBBS, DOMS, FGO</h5>
                            <h5 class="mb-15">Consultant Ophthalmologist</h5>
                            ...
                            <p class="color-mid mb-20 paragraph">Dr. Janhavi completed her MBBS from Bangalore Medical College and Research Institute in 2008 and post-graduation in ophthalmology (DOMS) from Minto Regional Institute of Ophthalmology in 2011.She then did her Fellowship in General ophthalmology from B. W. Lions superspeciality Eye Hospital in 2012. She was as a Consultant Ophthalmologist at Vasan Eye care for 5 years before joining Bangalore Nethralaya in 2017.</p>
                           <div class="spl">
                                 <a href="appointment.php" class="btn btn-blue">Make Appointment</a>
          <a class="btn btn-round btn-blue" href="alok.php"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
<a class="btn btn-round btn-blue" href="ajay.php"><i class="fa fa-chevron-right" aria-hidden="true" ></i></a>
