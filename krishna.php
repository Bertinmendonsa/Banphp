            ...
            <section class="doctors-area doctors-list ptb-80 bg-gray">
                <div class="container">
                         <div class="row pb-60" id="view1">
                            ...
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/doctors/prasadadmin.jpg"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox">
                            <h3 class="t-uppercase">
                                <a class="profilename">Shri G. Krishna Prasad</a>
                            </h3>
<!--                            <h5 class="mb-15 color-theme">MBBS, DOMS, FGO</h5>-->
                            <h5 class="mb-15">Administrator (Banashankari)</h5>
