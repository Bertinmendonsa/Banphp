                ...
                <div class="container">
                   <div class="row pb-60" id="view1">
                        <div class="col-lg-4 col-md-5 ptb-10 photo" >
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img=""></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox">
                            <h3 class="t-uppercase">
                                <a class="profilename">Shri P. Shiva Rao</a>
                            </h3>
<!--                            <h5 class="mb-15 color-theme">MBBS, DA </h5>-->
                            <h5 class="mb-15">Director</h5>
...
<p class="color-mid mb-20">Guide and instrumental in the growth of Bangalore Nethralaya since its days of inception.
Renowned Advocate and legal advisor to the prominent departments in the government of Andhra Pradesh.
A visionary and hard working personality for the social causes and upliftment of the society.</p>
