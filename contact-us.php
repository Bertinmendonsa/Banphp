...
*/
	...
	<div id="pageWrapper" class="page-wrapper">
		...
		<!-- –––––––––––––––[ PAGE CONTENT ]––––––––––––––– -->
		<main id="mainContent" class="main-content padding">
			<!-- Start Hero Area -->
            <div id="imgbck">
			<section class="section breadcrumb-area bg-ct pt-100 pb-80 subbanner overlay image1" >
...
<!--                            <h2 class="section-title mb-20 font-22 t-uppercase">Contact US</h2>-->
                            ...
                            <p class="color-mid"><h3>We Provide services at convinient locations with expanded hours to fit your family's busy schedule.</h3></p>
                        </div>
                    </div>
                    <div class="row mb-20">
                        <div class="col-md-offset-2 col-md-8">
                            <iframe class="border-video" width="100%" height="345" src="https://www.youtube.com/embed/9xc1TFOYQIM?autoplay=1">
                            </iframe>
                        </div>
                    </div>
                    <div class="row mb-20">
                        <div class="col-md-6 col-sm-6 mb-30">
                            <div class="contact-box">
                                ...
                                <h5 class="t-uppercase mb-10">BANASHANKARI,  BANGALORE</h5>
                                <p class="color-mid">#946<br/>21st Main<br/>Banashankari 2nd Stage,<br/>Near BDA Complex<br/>Bangalore - 70<br/>India.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 mb-30 ">
                            <div class="contact-box">
                                ...
                                <h5 class="t-uppercase mb-10">KALYAN NAGAR, BANGALORE</h5>
                                <p class="color-mid">"Samrudhi Plaza" No.714<br/>5th 'D' Cross, 2nd Block, HRBR layout<br> Kalyan Nagar <br/>Adjacent to Garbhagudi, IVF Center<br/>Near Hennur Police Station<br/>Bangalore -560 043</p>
                            </div>
                        </div>
                    
                    </div>
                    <div class="row row-md-cell  col-md-push-1 row-rl-0 pb-20 pb-md-60">
                         <div class="col-md-7 col-md-push-6 pb-40 pb-md-0">
                       
                            <div class="mapouter"><div class="gmap_canvas"><iframe width="530" height="400" id="gmap_canvas" src="https://maps.google.com/maps?q=Bangalore%20Nethralaya%20KALYAN%20NAGAR%20BANGALORE%2C%20Karnataka%2C%20India&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div></div>
                        </div>
                        <div class="col-md-5 col-md-pull-6 pr-20 pr-md-30 pl-xs-0 pb-40 pb-md-0">
                        <div class="mapouter"><div class="gmap_canvas"><iframe width="530" height="400" id="gmap_canvas1" src="https://maps.google.com/maps?q=Bangalore%20Nethralaya%2C%20Banashankari%20Stage%20II%2C%20Bengaluru%2C%20Karnataka%2C%20India&t=&z=15&ie=UTF8&iwloc=&output=embed"  frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe></div></div>
                        </div>
                    </div>
