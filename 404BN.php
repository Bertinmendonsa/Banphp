...
<html>
	...
	<div id="pageWrapper" class="page-wrapper">
        ...
        <!-- –––––––––––––––[ PAGE CONTENT ]––––––––––––––– -->
        <main id="mainContent" class="main-content main-404" >



            <section class="doctors-area doctors-list ptb-80 bg-404">
                <div class="container">
                   <div class="row pb-60" id="view2">
<!--
                       <div class="col-lg-4 col-md-5 ptb-10 bg">
                            image
                           
                        </div>
-->
                        <div class="col-lg-8 col-md-7 ptb-10 teambox col-lg-offset-2 t-c">
<!--                          error-->
                            <h2 class="color-blue">Sorry we could not find your reqested File</h2>
                            <figure>
                                <img src="assets/images/woody-404.png" alt="Sorry">
                            </figure>
                           <button class="btn btn-custom"><a href="index.php">Home</a></button>
                        </div>
                    </div>
				</div>
            </section>
