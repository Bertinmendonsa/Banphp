...
<link rel="stylesheet" type="text/css" href="assets/css/tipuesearch.css">
	...
	<div id="pageWrapper" class="page-wrapper">
        ...
        <main id="mainContent" class="main-content" >
            ...
            <section class="doctors-area doctors-list ptb-80 bg-gray">
                <div class="container">
                    <div class="row pb-60" id="view2">
                        <div class="col-lg-4 col-md-5 ptb-10 photo" >
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/rao.jpg"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox navalign">
                            <h3 >
                                <a class="profilename">Dr. N. Veerabhadra Rao</a>
                            </h3>
                             <h5 class="mb-15">MBBS, MS, FRCS (UK) FVRS</h5>
                            <h5 class="mb-15">Vitreo-Retinal Surgeon</h5>
                            <ul class="social-icons list-inline font-16 mb-20">
                                <li class="social-icons__item"><a href="index.php"><i class="fa fa-facebook"></i></a></li>
                                <li class="social-icons__item"><a href="index.php"><i class="fa fa-twitter"></i></a></li>
                                <li class="social-icons__item"><a href="index.php"><i class="fa fa-linkedin"></i></a></li>
                                <!--<li class="social-icons__item"><a href="index.php"><i class="fa fa-google-plus"></i></a></li>
                                <!--<li class="social-icons__item"><a href="#"><i class="fa fa-pinterest"></i></a></li>-->
                            </ul>
                            <p class="color-mid mb-20 paragraph">Dr. Rao is an alumnus of JJMMC, Davangere and KMC, Manipal. Holds FRCS from Glasgow, UK and specialised in Surgical Retina from Aravind Eye Hospital, Madurai. <br/><br/> He has almost 2 decades of experience in the field of Ophthalmology and Vitreo Retinal Services. He has special interests in Diabetic Retinopathy, Retinopathy of Prematurity (ROP) & Age Related Macular Degeneration (AMD).<br/><br>He has the accolade of successfully carrying out around 4000 complicated Retinal Surgeries.  With his high concern for preventing and creating awareness in blinding Retinal diseases, he has been dedicating time travelling all over Karnataka and Southern Andhra Pradesh and carved his niche in serving people with late stage Retinal diseases.</p>
                            <div class="spl" >
                                 <a href="appointment.php" class="btn btn-blue">Make Appointment</a>
          <a class="btn btn-round btn-blue" href="shivayogi.php"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
          <a class="btn btn-round btn-blue" href="sharadha.php" data-slide="next"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
      </div>
                                                   </div>
                    </div>
                </div>
