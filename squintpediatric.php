   ...
   <body id="body" class="wide-layout preloader-active">
	...
	<div id="pageWrapper" class="page-wrapper">
        ...
        <main id="mainContent" class="main-content" style="padding-top: 6em;">
			<!-- Start Hero Area -->
            <section class="section breadcrumb-area bg-ct pt-100 pb-80 subbanner overlay" style="background-image: url(assets/images/slider/subbanner.png)" >
                <div class="container t-center">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1 col-xs-12 text-center">
                            <div class="section-top-title">
                                <h1 class="t-uppercase font-45">Squint & Pediatric Opthamology</h1>
                                <ol class="breadcrumb">
<!--
