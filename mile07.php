...
<html>
	...
	<!-- PAGE TITLE                                -->
	<!-- ––––––––––––––––––––––––––––––––––––––––– -->
	<title>Banglore Nethralaya</title>
    ...
    <link href="assets/css/search1.css" rel="stylesheet">
     <link href="assets/css/animate.css" rel="stylesheet">
        ...
        <link rel="stylesheet" href="assets/css/slider.css">
         ...
         <link rel="stylesheet" href="assets/css/milecontent.css">
			...
			<div class="box">							
				<div class="icon">
					...
					<div class="info">
                        ...
                        <li>Started by Dr. N Veerabhadra Rao, Vitreo-Retinal Surgeon and Dr. P. Sharada Rao, a Glaucoma & Refractive Surgeon.</li>
                           <li>Major Motto <strong>“THE BEST EYE CARE TO MANKIND”.</strong></li>
                           <li>Started with 2 Bed hospital in Banashankari II Stage, Bangalore.</li>
                           <li>FFA, Green Lasers & Operation Theatre equipped with Phaco & Vitrectomy Machine.</li>
                           <li>Started Sharada Optical wing in the same premises.</li>                         <li>Inaugurated by then Honorable Union Minister Sri M. V. Rajashekharan, Dr. Kim Ramasamy(Retina Chief at Aravind Eye Hospital, Madurai) and Dr. Usha Kim(Chief, Orbit & Oculoplasty at Aravind Eye Hospital, Madurai).</li></div>
				</div>
				<div class="space"></div>
			</div> 
            </div>
