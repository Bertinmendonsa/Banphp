                ...
                <div class="container">
                   <div class="row pb-60" id="view1">
                        <div class="col-lg-4 col-md-5 photo">
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/Ajay.jpg"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox navalign">
                            <h3 class="t-uppercase">
                                <a class="profilename">Dr. Ajay Y. H.</a>
                            </h3>
                            <h5 class="mb-15">MBBS, MS, FPOS </h5>
                            <h5 class="mb-15">Squint & Pediatric Ophthalmologist</h5>
...
<!--                            <p class="color-mid mb-20">Details yet to be given</p>-->
          ...
          <a class="btn btn-round btn-blue" href="janhavi.php"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
<a class="btn btn-round btn-blue" href="sukhdeep.php"><i class="fa fa-chevron-right" aria-hidden="true" ></i></a>
