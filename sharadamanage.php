                ...
                <div class="container">
                    <div class="row pb-60" id="view1">
                        <div class="col-lg-4 col-md-5 ptb-10 photo" >
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/sharadaa.JPG"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox">
                            ...
                            <h5 class="mb-15">Co-Chairman & Medical Director-Kalyan Nagar</h5>
