...
<html>
    ...
    <link href="assets/css/supportiveservice.css" rel="stylesheet">
...
*/
	...
	<div id="pageWrapper" class="page-wrapper">
		...
		<main id="mainContent" class="main-content" style="padding-top: 6em;">
            ...
            <section class="section breadcrumb-area bg-ct pt-100 pb-80 subbanner overlay overlaybg" >
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1 col-xs-12 text-center">
                            <div class="section-top-title">
                                <h1 class="t-uppercase font-45 animated fadeInDown" >Supportive Services</h1>
             ...
             <section class="section breadcrumb-area pb-80">
        <div class="container">
            <div class="row pt-15">
                        <div class="col-md-4 ptb-15 fl-l" >
    ...
    <div class="row" id="about">
        ...
        <img src="assets/images/services/pharmacy-banner.jpg" class="supportiveimg">
        </div>
        
        <div class="col-md-7">
            <h2 class="mb-10 colorblack heading" >About Pharmacy<strong><span></span></strong></h2>
            <p id="fsize"  class="colorblack txtJustify">Bangalore Nethralaya offers onsite shop for corrective, cosmetic and therapeutic eyewear through Sharada Opticals. As specialized in-house opticals, we dispense excellent custom-made spectacles using products from the world’s best manufacturers at affordable and competitive prices. We provide everything in eyewear, spectacle frames, spectacles lenses, contact lenses, sunglasses, contact lens care solutions, accessories etc. 
            We specialize in special products like progressives, high index lenses, polycarbonates, Polarized lenses, anti-reflection coated lenses and photo chromatic lenses.<!--Bangalore Nethralaya is the brain child of Dr. N. Veerabhadra Rao and Dr. Sharada P. Rao. Both of them believe that scenario of the blindness both locally and internationally can be addressed in much more efficient and effective manner. Keeping the vision of serving the society at a larger level, Bangalore Nethralaya aims at following aspects--></p>
        </div>
    </div>
</div> 
        </section>
