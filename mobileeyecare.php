...
*/
	...
	<div id="pageWrapper" class="page-wrapper">
		...
		<main id="mainContent" class="main-content padding">
			<!-- Start Hero Area -->
            <div id="background">
            <section class="section breadcrumb-area bg-ct pt-100 pb-80 subbanner overlay imge">
                <div class="container t-center">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1 col-xs-12 text-center">
                            <div class="section-top-title">
                                <h1 class="t-uppercase font-45 animated fadeInDown ">Community Services</h1>
        ...
        <div class="container">
            <div class="row pt-15">
                        <div class="col-md-4 ptb-15 floatleft">
