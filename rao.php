...
<html>
	...
	<link href="assets/css/rao.css" rel="stylesheet">
	<!-- Bootstrap -->
                ...
                <div class="container">
                    <div class="row pb-60" id="view2">
                        <div class="col-lg-4 col-md-5 ptb-10 photo" >
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/doctors/veerabhadrabn.jpg"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox">
                            <h3 class="t-uppercase">
                                <a class="profilename">Dr. N. Veerabhadra Rao</a>
                            </h3>
                             <!--<h5 class="mb-15 ">MBBS, MS, FRCS (UK) FVRS</h5>-->
                            <h5 class="mb-15 ">Chairman & Medical Director-Banashankari</h5>
