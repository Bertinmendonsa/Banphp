                ...
                <div class="container">
                   <div class="row pb-60" id="view1">
                        <div class="col-lg-4 col-md-5 ptb-10 photo" >
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/doctors/sathya.jpg"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox">
                            <h3 class="t-uppercase">
                                <a class="profilename">Shri N. Sathyanarayana</a>
                            </h3>
<!--                            <h5 class="mb-15 color-theme">MBBS, DA </h5>-->
                            ...
                            <p class="color-mid mb-20">Instrumental for the guidance and support of Bangaluru Nethralaya. Earned his B.E  in E & C from S J C E Mysore, He has been working in the IT industry from last 20 years with various positions. Currently working as a Director for a value based healthcare company and resides in Ashburn, VA suburbs of Washington D C, USA.</p>
