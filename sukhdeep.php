                ...
                <div class="container">
                   <div class="row pb-60" id="view1">
                        <div class="col-lg-4 col-md-5">
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct photo1" data-bg-img="assets/images/Sukdeep.jpg" ></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox navalign">
                            <h3 class="t-uppercase">
                                <a class="profilename">Dr. Sukhdeep Bains</a>
                            </h3>
                            <h5 class="mb-15">MBBS, MS, DNB, FIOO </h5>
...
<!--                            <p class="color-mid mb-20">Details yet to be given</p>-->
          ...
          <a class="btn btn-round btn-blue" href="ajay.php"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
          <a class="btn btn-rounf=d btn-blue" href="shivayogi.php" data-slide="next"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
      </div>
<!--                            <a href="appointment.php" class="btn btn-blue">Make Appointment</a>-->
                        </div>
                    </div>
