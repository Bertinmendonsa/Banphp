                    ...
                    <div class="row pt-30">
                        <div class="col-md-6">
                            <div class="who-we-are mb-40">
                               ...
                               <p class="paragraph fsize" id="fsize">Bangalore Nethralaya is one of the leading super specialty eye care hospital based in Bangalore.  With the vision to serve the society and cater to needs of people from all walks of life, Bangalore Nethralaya was started in the year 2007. Since last 10yrs, the organization has grown to two branches in Bangalore and has plans to expand.<br/><br/>Bangalore Nethralaya is the brain child of Dr. N. Veerabhadra Rao and Dr. Sharada P. Rao. Both of them believe that scenario of the blindness both locally and internationally can be addressed in much more efficient and effective manner. Keeping the vision of serving the society at a larger level, Bangalore Nethralaya aims providing end to end eye care solution to entire mankind.<br/><br/>Ethical practice, quality and service are the major driving factors for Bangalore Nethralaya. We offer wide range of services in the ophthalmology with sub specialties such as Glaucoma, Cataract, Retina, Refractive surgeries, Orbit & Oculoplasty, and Pediatric Ophthalmology...</p>
                        ...
                        <div class="row">
                            ...
                            <div class="main_counter_content text-center white-text wow fadeInUp">
                                <div class="col-md-3" >
                                    ...
                                    <div class="single_counter" style="background-color: #062433;padding-bottom: 1em;padding-top: 1em;color: white">
...
<!--
  ...
  <div class="row" id="slider-text">
    <div class="col-md-6 col-md-offset-3">
      <h2 class="float-center">CLINICAL SERVICES</h2>
    </div>
...
<!--            vcouner code-->
       ...
       <!-- <div id="slider-control">
        <a class="left carousel-control" href="#itemslider3" data-slide="prev"><img src="https://s12.postimg.org/uj3ffq90d/arrow_left.png" alt="Left" class="img-responsive"></a>
        <a class="right carousel-control" href="#itemslider3" data-slide="next"><img src="https://s12.postimg.org/djuh0gxst/arrow_right.png" alt="Right" class="img-responsive"></a>
      </div>-->
                                    </div>
      ...
      <div class="carousel carousel-showmanymoveone slide" id="itemslider">
        <div class="carousel-inner">
          ...
          <div class="item active">
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="team-card">
                    <div class="slid-img">
                        <img src="assets/images/rao.jpg" class="img-responsive center-block">
                    </div>
                    <div class="slid-content">
                        <h3 class="text-center font-Name">Dr. N. Veerabhadra Rao</h3>
                        <h4 class="text-center padd">Vitreo-Retinal Surgeon</h4>
                        
                        <div class="top-border">
                            <div class="left-float" >
                                <a href="veerabhadra.php"><button class="btn-mor btn-pro"><span>View Profile</span></button></a>
                            </div>
                            <div class="right-float" >
                                <a  href="" class="btn-ancr social-icons__item pt-10"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr social-icons__item pt-10"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr social-icons__item pt-10"><i class="fa fa-linkedin fa-2x" aria-hidden="true"></i></a>
                            </div>
                        </div>
          ...
          <div class="item">
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="team-card">
                    <div class="slid-img">
                    <img src="assets/images/doctors/sharadabn.jpg" class="img-responsive center-block">
                </div>
                <div class="slid-content">
                    <h3 class="text-center font-Name">Dr. Sharada P. Rao</h3>
                    
                    <h4 class="text-center padd">Glaucoma & Refractive Surgeon</h4>   
                    
                     <div class="top-border">
                            <div class="left-float" >
                                <a href="sharadha.php" ><button class="btn-mor btn-pro"><span>View Profile</span></button></a>
                            </div>
                            <div class="right-float" >
                                <a  href="" class="btn-ancr"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr"><i class="fa fa-linkedin fa-2x" aria-hidden="true"></i></a>
                            </div>
                        </div>
          ...
          <div class="item">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="team-card">
              <div class="slid-img">
                    <img src="assets/images/doctors/Alok.jpg" class="img-responsive center-block">
                </div>
                <div class="slid-content">
                    <h3 class="text-center font-Name">Dr. Alok B Swamy</h3>
                    
                    <h4 class="text-center padd">Cornea, Refractive & Phaco Surgeon</h4>   
                    
                     <div class="top-border">
                            <div class="left-float" >
                                <a href="alok.php" ><button class="btn-mor btn-pro"><span>View Profile</span></button></a>
                            </div>
                            <div class="right-float" >
                                <a  href="" class="btn-ancr"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
        ...
        <!--  <div class="item">
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="team-card">
             <div class="slid-img">
                    <img src="assets/images/namratha.jpg" class="img-responsive center-block">
                </div>
                <div class="slid-content">
                    <h3 class="text-center font-Name">Dr Namratha Dudeja</h3>
                    
                    <h4 class="text-center padd">Glaucoma & Phaco Surgeon</h4>   
                    
                     <div class="top-border">
                            <div class="left-float" >
                                <a href="namratha.php" ><button class="btn-mor btn-pro"><span>View Profile</span></button></a>
                            </div>
                            <div class="right-float" >
                                <a  href="" class="btn-ancr"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
          ...
          <div class="item">
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="team-card">
              <div class="slid-img">
                    <img src="assets/images/doctors/Janhavi.JPG" class="img-responsive center-block">
                </div>
                <div class="slid-content">
                    <h3 class="text-center font-Name">Dr Janhavi H</h3>
                    
                    <h4 class="text-center padd">Consultant Ophthalmologist</h4>  
                    
                     <div class="top-border">
                            <div class="left-float" >
                                <a href="janhavi.php" ><button class="btn-mor btn-pro"><span>View Profile</span></button></a>
                            </div>
                            <div class="right-float" >
                                <a  href="" class="btn-ancr"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="team-card">
              <div class="slid-img">
                    <img src="assets/images/Ajay.jpg" class="img-responsive center-block">
                </div>
                <div class="slid-content">
                    <h3 class="text-center font-Name">Dr. Ajay Y. H.</h3>
                    
                    <h4 class="text-center padd">Squint & Pediatric Ophthalmologist</h4>   
                    
                     <div class="top-border">
                            <div class="left-float" >
                                <a href="ajay.php" ><button class="btn-mor btn-pro"><span>View Profile</span></button></a>
                            </div>
                            <div class="right-float" >
                                <a  href="" class="btn-ancr"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="team-card">
              <div class="slid-img">
                    <img src="assets/images/Sukdeep.jpg" class="img-responsive center-block">
                </div>
                <div class="slid-content">
                    <h3 class="text-center font-Name">Dr. Sukhdeep Bains</h3>
                    
                    <h4 class="text-center padd">Visiting Orbit & Oculoplasty Surgeon</h4>  
                    
                    <div class="top-border">
                            <div class="left-float" >
                                <a href="sukhdeep.php" ><button class="btn-mor btn-pro"><span>View Profile</span></button></a>
                            </div>
                            <div class="right-float" >
                                <a  href="" class="btn-ancr"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
                <div class="team-card">
              <div class="slid-img">
                    <img src="assets/images/shivyogi.jpg" class="img-responsive center-block">
                </div>
                <div class="slid-content">
                    <h3 class="text-center font-Name">Dr. Shivayogi Kusagur</h3>
                    
                    <h4 class="text-center padd">Visiting Orbit & Oculoplasty Surgeon</h4>   
                    
                     <div class="top-border">
                            <div class="left-float" >
                                <a href="shivayogi.php" ><button class="btn-mor btn-pro"><span>View Profile</span></button></a>
                            </div>
                            <div class="right-float" >
                                <a  href="" class="btn-ancr"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
...
<!--
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
              ...
              <div class="slid-img">
                ...
                <div class="slid-content">
                    <h3 class="text-center font-Name">Dr. Praveen Kumar</h3>
                    
                    <h4 class="text-center padd" >Consultant Anesthetist</h4>  
                    
                     <div class="top-border">
                            <div class="left-float" >
                                <a href="praveen.php" ><button class="btn-mor btn-pro"><span>View Profile</span></button></a>
                            </div>
                            <div class="right-float" >
                                <a  href="" class="btn-ancr"><i class="fa fa-facebook fa-2x" aria-hidden="true"></i></a>
                        <a  href="" class="btn-ancr"><i class="fa fa-twitter fa-2x" aria-hidden="true"></i></a>
...
<br>
       ...
       <!--  <div id="slider-control">
            <a class="right carousel-control" href="#itemslider1" data-slide="next"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
        <a class="left carousel-control" href="#itemslider1" data-slide="prev"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
