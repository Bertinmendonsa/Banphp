                ...
                <div class="container">
                    <div class="row pb-60" id="view2">
                        <div class="col-lg-4 col-md-5 ptb-10 photo" >
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/doctors/sharadabn.jpg"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox navalign">
                            <h3 class="t-uppercase">
                                <a class="profilename">Dr. Sharada P. Rao</a>
                            </h3>
                             <h5 class="mb-15">MBBS, MS,FICO(UK)</h5>
                            <h5 class="mb-15">Glaucoma & Refractive Surgeon</h5>
                            <ul class="social-icons list-inline font-16 mb-20">
                                ...
                                <li class="social-icons__item"><a href="index.php"><i class="fa fa-pinterest"></i></a></li>-->
                            </ul>
                            <p class="color-mid mb-20 paragraph">Dr. Sharada holds medical degree from Osmania Medical College, Hyderabad and MS in Ophthalmology from Kakatiya Medical College, Warrangal. She is a Fellow of International Council of Ophthalmology (FICO) and has undergone training in Glaucoma Services at Aravind Eye Hospital, Madurai.<br><br>She has 12yrs of experience in Glaucoma, Cornea & Refractive Surgeries. She has wide range of experience and expertise in Refractive Surgical Services like LASIK, PRK & ICL.  She has proven track record of conducting multiple successful surgeries in the management of early & Advanced Glaucoma (Glaucoma Drainage Devices) and Keratoconus.</p>
<!--                            <a href="appointment.php" class="btn btn-blue">Make Appoinment</a>-->
                             <div class="spl">
                                 <a href="appointment.php" class="btn btn-blue">Make Appointment</a>
          <a class="btn btn-round btn-blue" href="veerabhadra.php"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
<a class="btn btn-round btn-blue" href="alok.php"><i class="fa fa-chevron-right" aria-hidden="true" ></i></a>
