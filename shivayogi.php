                ...
                <div class="container">
                   <div class="row pb-60" id="view1">
                        <div class="col-lg-4 col-md-5 ptb-10 photo">
                            <figure class="embed-responsive embed-responsive-4by3 bg-ct" data-bg-img="assets/images/shivyogi.jpg"></figure>
                        </div>
                        <div class="col-lg-8 col-md-7 ptb-10 teambox navalign">
                            <h3 class="t-uppercase">
                                <a class="profilename">Dr. Shivayogi Kusagur</a>
                            </h3>
                            <h5 class="mb-15">MBBS, MS, FIOO </h5>
                            <h5 class="mb-15">Visiting Orbit & Oculoplasty Surgeon</h5>
...
<!--                            <p class="color-mid mb-20">Details yet to be given</p>-->
                            <div class="spl">
                                 <a href="appointment.php" class="btn btn-blue">Make Appointment</a>
          <a class="btn btn-round btn-blue" href="sukhdeep.php"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
<a class="btn btn-round btn-blue" href="veerabhadra.php"><i class="fa fa-chevron-right" aria-hidden="true" ></i></a>
