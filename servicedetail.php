        ...
        <!-- –––––––––––––––[ HEADER ]––––––––––––––– -->
              <main id="mainContent" class="main-content" style="padding-top: 8em;">
                    ...
                    <div class="container-fluid nopadding">
                         <h2  class="color-blue t-c">CATARACT</h2>
                        <div class="row">
                            
                        <div class="col-md-offset-2 col-md-8 shadow" >
                           
                        <div class="panel panel-default" >
                            <div class="panel-heading"><h3>About Cataract</h3></div>
   <marquee> <div class="panel-body"><p class="paragraph mrqtxt">A cataract is a clouding that develops in the crystalline lens of the eye, varying in degree from slight to complete opacity and obstructing the passage of light. <a href="#">Readmore</a></p>
                           </div></marquee>
                            <div class="panel panel-default" >
                            <div class="panel-heading"><h3>Treatment</h3></div>
    <div class="panel-body">Presently cataract is removed with latest technology of phacoemulsification with foldable intra-ocular lens implantation technique under topical anesthesia in a few minutes.<a href="#">Readmore</a></div>
                            </div>
                            <div class="panel panel-default" >
                            <div class="panel-heading"><h3>Experts</h3></div>
    <div class="panel-body"><ul>
        <li><a href="veerabhadra.html"> Dr. Veerabhadra Rao</a></li>
        <li><a href="alok.html"> Dr. Alok</a></li>
        
        <li><a href="ajay.html"> Dr. Ajay</a></li>
        <li><a href="sharadha.html"> Dr. Sharada P.Rao</a></li>
        </ul></div>
                            </div>
                            <div class="panel panel-default" >
    ...
    <div class="panel-body"><p>Around 10000 cataract surgeries across two branches of Bangalore Nethralaya in Bangalore</p></div>
                            </div>
                            <div class="panel panel-default" >
                            <div class="panel-heading"><h3>Testimonials</h3></div>
    <div class="panel-body">asedrtfgyuhjikopl;;lkjhgfcvgbhjnk</div>
                            </div>
                            </div>
                            </div>
                            </div>
